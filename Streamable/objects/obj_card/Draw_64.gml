...
if (is_token)
{
	var token_width = sprite_get_width(spr_d2);
	var token_height = sprite_get_height(spr_d2);
	draw_sprite_ext(spr_d2, 0, x1 - token_width / 8, y1 - token_height / 8, 0.25, 0.25, 0, c_white, 0.85);
}

// Write to webcam surface:
if !camera_mirroring_enabled() return;
