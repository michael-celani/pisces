...
var checkbox = instance_create_layer(x + 20, y + 140,"UI",obj_checkbox,
{
	"parent_component": id,
...
var check_label2 = instance_create_layer(checkbox.x + checkbox.image_xscale+10,checkbox.y + checkbox.image_yscale / 2,"UI", obj_label, {
	"parent_component": id,
	"label_font": fnt_beleren,
...
var button = instance_create_layer(x + 20, y + 210, "UI", obj_button,
{
	"parent_component": id,
